 ...
 */
final class Version20231106143653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nft (id INT AUTO_INCREMENT NOT NULL, nft:read INT NOT NULL, name VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, launch_date DATETIME NOT NULL, launch_price_eur DOUBLE PRECISION NOT NULL, launch_price_eth DOUBLE PRECISION NOT NULL, INDEX IDX_D9C7463C8A1465B4 (nft:read), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
